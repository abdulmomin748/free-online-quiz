...
const Nav = () => {
  ...
  return (
    <div className='shadow-lg fixed top-0 left-0 right-0 z-10 bg-white'>
      <div className='py-5 mx-auto max-w-7xl md:px-4 px-5'>
      <div className='relative flex items-center justify-between'>
        ...
        <ul className='flex items-center space-x-8 navlink'>
          <li>
            <NavLink
              to='/home'
              aria-label='Home'
                ...
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    ...
                    >
                      ...
                      <span className='ml-2 text-[14px] sm:text-xl font-bold tracking-wide text-gray-800 uppercase'>
                         Free Online Quiz
                      </span>
                    </Link>
                  </div>
