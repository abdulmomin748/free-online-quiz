    ...
    <footer className='px-4 divide-y'>
      <div className='container flex flex-col max-w-7xl	 justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0'>
        ...
        <div className='grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4'>
          ...
          <div className='space-y-3'>
            <h3 className='tracking-wide  uppercase font-semibold '>Online Quiz</h3>
            <ul className='space-y-1'>
              <li>
          ...
          <div className='space-y-3'>
            <h3 className='uppercase font-semibold'> Quick Link</h3>
            <ul className='space-y-1'>
              <li>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex justify-start space-x-3'>
              <Link
                to='/about'
                title='Facebook'
                className='flex items-center flex items-center justify-center w-8 h-8 rounded-full bg-cyan-200 p-1'
              >
                <svg
              ...
              <Link
                to='/about'
                title='Instagram'
                className='flex items-center justify-center w-8 h-8 rounded-full bg-cyan-200 p-1'
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 32 32'
