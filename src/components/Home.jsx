  ...
  return (
    <section>
      ...
      <section className="text-gray-600 body-font mt-24 text-center max-w-7xl m-auto">
            <h2 className="ttext-3xl font-bold relative mb-10 quiz-title pb-5 leading-none text-center sm:text-4xl">Choose the topics as you like</h2>
            ...
            <div className="max-w-7xl mx-auto md:px-4 pb-32">
